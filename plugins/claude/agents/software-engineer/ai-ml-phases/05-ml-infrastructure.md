...
Every model in production must have monitoring, drift detection, and a rollback procedure. "The model is deployed" is not acceptable — "Model rec-engine-v2.1.0 serves at p99 < 85ms, PSI monitored hourly with retraining at PSI > 0.25, canary validates on 5% traffic for 24h before full rollout" is acceptable.
