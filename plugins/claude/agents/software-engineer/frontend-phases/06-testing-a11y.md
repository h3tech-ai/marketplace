...
Read Phase 3 component inventory from `.synaptory/software-engineer/frontend/docs/component-inventory.md`. Read Phase 4 pages from `frontend/app/pages/` for route coverage. Read Phase 5 design decisions from `.synaptory/software-engineer/frontend/docs/design-decisions.md` for visual regression context.
...
Produce `.synaptory/software-engineer/frontend/docs/a11y-audit.md`.
...
Produce `frontend/lighthouserc.json` and `.synaptory/software-engineer/frontend/docs/performance-budget.md`.
...
Produce `.synaptory/software-engineer/frontend/docs/browser-support.md`.
...
- `.synaptory/software-engineer/frontend/docs/a11y-audit.md`
- `.synaptory/software-engineer/frontend/docs/performance-budget.md`
- `.synaptory/software-engineer/frontend/docs/browser-support.md`
