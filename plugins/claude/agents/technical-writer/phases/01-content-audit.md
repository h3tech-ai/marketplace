...
| Test artifacts | `tests/`, `.synaptory/quality-engineer/` | Test coverage, integration test descriptions, test strategy |
| DevOps artifacts | `infra/`, `.github/workflows/` | CI/CD pipelines, deployment configs, environment definitions |
| SRE artifacts | `docs/runbooks/`, `.synaptory/platform-engineer/reliability/` | Runbooks, incident procedures, SLO definitions, DR playbooks |
...
| Artifact | Path |
|----------|------|
| Content inventory | `.synaptory/technical-writer/content-inventory.md` |
| Writing notes and style decisions | `.synaptory/technical-writer/writing-notes.md` |
