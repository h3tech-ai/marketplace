...
| Test artifacts | `tests/`, `.synaptory/quality-engineer/test-plan.md` | Test strategy, coverage requirements |
...
| Content inventory | `.synaptory/technical-writer/content-inventory.md` | Phase 1 priorities |
...
1. **Testing philosophy** — Testing strategy extracted from `.synaptory/quality-engineer/test-plan.md`
