...
| Content inventory | `.synaptory/technical-writer/content-inventory.md` | Sitemap from Phase 1 |
...
Document the chosen approach in `.synaptory/technical-writer/writing-notes.md`.
...
2. Document the versioning workflow in `.synaptory/technical-writer/writing-notes.md`:
...
| Writing notes (updated) | `.synaptory/technical-writer/writing-notes.md` |
