...
def generate_design_system(query: str, project_name: str = None, output_format: str = "ascii",
    ...
    Args:
        ...
        persist: If True, save design system to .synaptory/.design-system/ folder
...
def persist_design_system(design_system: dict, page: str = None, output_dir: str = None, page_query: str = None) -> dict:
    """
    Persist design system to .synaptory/.design-system/<project>/ folder using Master + Overrides pattern.
    ...
    design_system_dir = base_dir / ".synaptory" / ".design-system" / project_slug
...
def format_master_md(design_system: dict) -> str:
    ...
    lines.append("")
    lines.append("> **LOGIC:** When building a specific page, first check `.synaptory/.design-system/pages/[page-name].md`.")
...
def format_page_override_md(design_system: dict, page_name: str, page_query: str = None) -> str:
    ...
    lines.append("")
    lines.append("> **IMPORTANT:** Rules in this file **override** the Master file (`.synaptory/.design-system/MASTER.md`).")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="synaptory Design System Generator")
