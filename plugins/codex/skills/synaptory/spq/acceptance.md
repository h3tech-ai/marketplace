...
```bash
MCP `spq_lifecycle` {"operation": "record_handover", "recorded_by": "<name>", "codebase": "<rev>", "documentation": "<doc ref>", "operating_knowledge": "<runbook ref>"}

MCP `spq_lifecycle` {"operation": "record_commitment", "description": "<what is still owed>", "recorded_by": "<name>"}

MCP `spq_lifecycle` {"operation": "discharge_commitment", "commitment_id": "<the id record_commitment returned>", "discharged_by": "<name>"}
```
