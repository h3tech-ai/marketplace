...
1. **Record the baseline.**
   ...
   ```bash
   MCP `spq_lifecycle` {"operation": "approve_baseline", "approved_by": "<the approving human's identity>", "baseline_ref": "<the specification revision the Cycles execute, e.g. BRD-1.0>", "calibration": {"sample": ["WU-001", "WU-002"], "measured_units": 2, "elapsed_hours": 11.5, "window": "2026-09-01..2026-09-05", "verification_depth": "unit + integration + review", "method": "two representative units carried end to end during Discovery"}}
   ```
