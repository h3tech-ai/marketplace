...
_plugin_name=$(python3 -c "import json,sys;print(json.load(open('${PLUGIN_ROOT}/.cursor-plugin/plugin.json'))['name'])" 2>/dev/null || echo "synaptory")
...
_plugin_json="${PLUGIN_ROOT}/.cursor-plugin/plugin.json"
