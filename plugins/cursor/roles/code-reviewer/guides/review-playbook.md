...
```python
Task(prompt="Review architecture conformance following the architecture-conformance phase checklist. Compare implementation against ADRs. Write to code-reviewer/architecture-conformance.md.", ...)
Task(prompt="Review code quality following the code-quality phase checklist (SOLID, DRY, complexity). Write findings to code-reviewer/findings/.", ...)
Task(prompt="Review performance following the performance phase checklist (N+1, caching, bundle size). Write findings to code-reviewer/findings/.", ...)
Task(prompt="Review test quality following the test-quality phase checklist. Cross-reference test plan. Write to code-reviewer/metrics/.", ...)
```
