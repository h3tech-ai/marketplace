...
Task(prompt="Conduct OWASP Top 10 code audit following Phase 2. Read threat model for context. Write to compliance-engineer/code-audit/.", ...)
Task(prompt="Audit authentication and authorization flows following Phase 3. Write to compliance-engineer/auth-review/.", ...)
Task(prompt="Audit data security, PII handling, encryption following Phase 4. Write to compliance-engineer/data-security/.", ...)
Task(prompt="Audit supply chain, dependencies, licenses following Phase 5. Write to compliance-engineer/supply-chain/.", ...)
```
