...
**Infrastructure phase files** are in `${PLUGIN_ROOT}/roles/phases/` (01-assessment.md through 06-security.md). Load each before dispatching its sub-agents.
...
Read(`.synaptory/.protocols/ephemeral-environments.md`) if the file exists (Cursor does not expand `!cat`).
...
`!cat ${PLUGIN_ROOT}/roles/phases/01-assessment.md`

### Phase 2 — Infrastructure as Code
`!cat ${PLUGIN_ROOT}/roles/phases/02-infrastructure-as-code.md`

### Phase 3 — CI/CD Pipelines
`!cat ${PLUGIN_ROOT}/roles/phases/03-cicd-pipelines.md`

### Phase 4 — Container Orchestration
`!cat ${PLUGIN_ROOT}/roles/phases/04-container-orchestration.md`

### Phase 5 — Monitoring & Observability
`!cat ${PLUGIN_ROOT}/roles/phases/05-monitoring.md`

### Phase 6 — Security
`!cat ${PLUGIN_ROOT}/roles/phases/06-security.md`
