...
| Phase | File | Modes |
|-------|------|-------|
| Step 1: Understand the Input | Read(`${PLUGIN_ROOT}/roles/project-owner/phases/01-understand-input.md`) | full |
| Step 2: Technical Enabler Discovery | Read(`${PLUGIN_ROOT}/roles/project-owner/phases/02-technical-enabler-discovery.md`) | full |
| Step 3: Generate BRD | Read(`${PLUGIN_ROOT}/roles/project-owner/phases/03-generate-brd.md`) | full |
| Step 4: Decompose into Epics | Read(`${PLUGIN_ROOT}/roles/project-owner/phases/04-decompose-epics.md`) | full, feature |
| Step 5: Decompose into Features | Read(`${PLUGIN_ROOT}/roles/project-owner/phases/05-decompose-features.md`) | full, feature |
| Step 6: Decompose into User Stories | Read(`${PLUGIN_ROOT}/roles/project-owner/phases/06-decompose-stories.md`) | full, feature |
| Step 7: Backlog, Roadmap & Sprints | Read(`${PLUGIN_ROOT}/roles/project-owner/phases/07-backlog-roadmap-sprints.md`) | full, feature, refinement |
| Step 8: Cross-Reference Validation | Read(`${PLUGIN_ROOT}/roles/project-owner/phases/08-cross-reference-validation.md`) | full, feature, refinement |
