...
Task(prompt="Write unit tests following Phase 2 rules. Read test-plan.md for traceability. Write to tests/unit/.", ...)
Task(prompt="Write integration tests following Phase 3 rules. Read test-plan.md. Write to tests/integration/.", ...)
Task(prompt="Write contract tests following Phase 4 rules. Read test-plan.md. Write to tests/contract/.", ...)
Task(prompt="Write E2E tests following Phase 5 rules. Read test-plan.md. Write to tests/e2e/.", ...)
Task(prompt="Write performance tests following Phase 6 rules. Read test-plan.md. Write to tests/performance/.", ...)
```
...
Read(`${PLUGIN_ROOT}/roles/quality-engineer/phases/01-test-planning.md`)
...
|-------|------|---------------|
| Phase 8: Test Data Management | Read(`${PLUGIN_ROOT}/roles/quality-engineer/phases/08-test-data.md`) | Sequential (before Group A) |
| Phase 2: Unit Tests | Read(`${PLUGIN_ROOT}/roles/quality-engineer/phases/02-unit-tests.md`) | Group A (parallel) |
| Phase 3: Integration Tests | Read(`${PLUGIN_ROOT}/roles/quality-engineer/phases/03-integration-tests.md`) | Group A (parallel) |
| Phase 4: Contract Tests (MANDATORY) | Read(`${PLUGIN_ROOT}/roles/quality-engineer/phases/04-contract-tests.md`) | Group A (parallel) |
| Phase 5: E2E Tests | Read(`${PLUGIN_ROOT}/roles/quality-engineer/phases/05-e2e-tests.md`) | Group A (parallel) |
| Phase 6: Performance Tests (MANDATORY) | Read(`${PLUGIN_ROOT}/roles/quality-engineer/phases/06-performance-tests.md`) | Group A (parallel) |
| Phase 9: Observability Tests (conditional) | Read(`${PLUGIN_ROOT}/roles/quality-engineer/phases/09-observability-tests.md`) | Group A (parallel, only if observability detected) |
| Phase 7: Test Infrastructure | Read(`${PLUGIN_ROOT}/roles/quality-engineer/phases/07-test-infrastructure.md`) | Sequential (after Group A) |
| Phase 10: Runtime Verification (conditional) | Read(`${PLUGIN_ROOT}/roles/quality-engineer/phases/10-runtime-verification.md`) | Sequential (LAST, when the story's DoD requires `runtime_verified`) |
...
Read(`${PLUGIN_ROOT}/roles/quality-engineer/phases/test-health.md`)
