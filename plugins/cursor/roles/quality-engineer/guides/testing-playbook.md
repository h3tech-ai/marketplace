...
`${PLUGIN_ROOT}/roles/quality-engineer/guides/testing-playbook.md`.
...
Use AskQuestion with options (never open-ended), "Chat about this" last,
...
3. Story ACs — run `python3 ${PLUGIN_ROOT}/skills/_shared/scripts/tracker/tracker_cli.py --project-dir . get-backlog` for the story list, then `tracker_cli.py --project-dir . get-story <id>` for individual ACs
