...
Read(`.synaptory/research-advisor/context/decisions.md`) if the file exists (Cursor does not expand `!cat`).
Read(`.synaptory/research-advisor/context/repo-map.md`) if the file exists (Cursor does not expand `!cat`).
...
`!cat ${PLUGIN_ROOT}/roles/reference/activation-intelligence.md 2>/dev/null || true`

---

## Dialogue Protocol

`!cat ${PLUGIN_ROOT}/roles/reference/dialogue-protocol.md 2>/dev/null || true`
...
`!cat ${PLUGIN_ROOT}/roles/reference/research-discipline.md 2>/dev/null || true`
...
`!cat ${PLUGIN_ROOT}/roles/reference/context-persistence.md 2>/dev/null || true`
