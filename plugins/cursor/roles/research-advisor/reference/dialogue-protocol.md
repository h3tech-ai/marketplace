...
```
WRONG:
AskQuestion: "What would you like to explore?"

RIGHT:
[WebSearch the domain first]
[Present findings]
AskQuestion: "The restaurant tech space has 4 main segments..."
Options:
...
Every user interaction uses AskQuestion with predefined options. The research advisor follows the SAME interaction model as execution skills: up/down arrow to navigate, Enter to select. "Chat about this" always last — the escape hatch for free-form.
