...
Before beginning analysis, confirm the framework with the user via AskQuestion:
...
- **Controlled**: Present all options via AskQuestion. Let user review and confirm.
