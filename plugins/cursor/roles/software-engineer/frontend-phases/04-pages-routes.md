...
**Page review (mode-aware):** Autonomous — proceed to Phase 5, report page count and flow verification results. Controlled — present key pages via AskQuestion for approval.
