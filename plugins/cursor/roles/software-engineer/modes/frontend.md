...
Read("${PLUGIN_ROOT}/skills/_shared/design-assets/ux-psychology.md")
```
...
Bash("python3 ${PLUGIN_ROOT}/skills/_shared/design-assets/scripts/search.py '[domain] [product-type]' --design-system")

# Search specific design domains
Bash("python3 ${PLUGIN_ROOT}/skills/_shared/design-assets/scripts/search.py '[query]' --domain style")
Bash("python3 ${PLUGIN_ROOT}/skills/_shared/design-assets/scripts/search.py '[query]' --domain color")
Bash("python3 ${PLUGIN_ROOT}/skills/_shared/design-assets/scripts/search.py '[query]' --domain typography")

# Persist design system to project
Bash("python3 ${PLUGIN_ROOT}/skills/_shared/design-assets/scripts/search.py '[domain] [product-type]' --design-system --persist")
```
...
Read("${PLUGIN_ROOT}/skills/_shared/design-assets/color-palettes.md")
Read("${PLUGIN_ROOT}/skills/_shared/design-assets/typography.md")
Read("${PLUGIN_ROOT}/skills/_shared/design-assets/spacing-layout.md")
Read("${PLUGIN_ROOT}/skills/_shared/design-assets/component-patterns.md")
```
...
Read("${PLUGIN_ROOT}/skills/_shared/design-assets/animation-guide.md")
# Visual effects — glassmorphism, shadows, gradients
Read("${PLUGIN_ROOT}/skills/_shared/design-assets/visual-effects.md")
```
...
| Degraded | `docs/architecture/tech-stack.md`, `docs/architecture/adrs/` | WARN — ask user for framework/auth choices via AskQuestion |
...
```python
# Run UX audit
Bash("python3 ${PLUGIN_ROOT}/skills/_shared/design-assets/scripts/ux_audit.py frontend/app/")

# Run accessibility checker
Bash("python3 ${PLUGIN_ROOT}/skills/_shared/scripts/accessibility_checker.py frontend/app/")
```
