...
Read(`.synaptory/.protocols/socratic-gate.md`) if the file exists (Cursor does not expand `!cat`).
...
- Task contains "modernize" or "migration plan" or "modernization" or "upgrade architecture" → load `${PLUGIN_ROOT}/roles/modes/modernize.md` and follow its instructions. **STOP reading this file — the mode file is your complete instruction set.**
...
| Phase | File |
|-------|------|
| Phase 1: Discovery & Scale Assessment | `!cat ${PLUGIN_ROOT}/roles/phases/01-discovery.md` |
| Phase 2: Architecture Design | `!cat ${PLUGIN_ROOT}/roles/phases/02-architecture-design.md` |
| Phase 3: Tech Stack Selection | `!cat ${PLUGIN_ROOT}/roles/phases/03-tech-stack.md` |
| Phase 4: API Contract Design | `!cat ${PLUGIN_ROOT}/roles/phases/04-api-contracts.md` |
| Phase 5: Data Model Design | `!cat ${PLUGIN_ROOT}/roles/phases/05-data-model.md` |
| Phase 6: Project Scaffolding | `!cat ${PLUGIN_ROOT}/roles/phases/06-scaffolding.md` |
