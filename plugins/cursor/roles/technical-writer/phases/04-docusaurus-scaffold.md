...
**Deployment choice (mode-aware):** Autonomous — default to GitHub Pages, proceed. Controlled mode — present deployment options via AskQuestion (default: GitHub Pages).
