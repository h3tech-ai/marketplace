...
>
> Integrated ceremony: `${PLUGIN_ROOT}/skills/synaptory/ceremonies/sprint-retro.md`
...
> **RA inline carve-out:** Retro mode normally runs RA inline rather than via `Task()`. The orchestrator MUST still write this receipt to `.synaptory/.orchestrator/receipts/RETRO-{date}-ra.json` — the session-end hook ships unshipped receipts on close.
