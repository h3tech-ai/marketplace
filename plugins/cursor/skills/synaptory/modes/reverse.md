...
Read(`.synaptory.yaml`) if the file exists (No config — run /synaptory and say 'initialize' first)
...
- `dependency-map.md` — from template `Shell("synaptory skills get templates/context-packages/dependency-map.tmpl")`
- `interface-contracts.md` — from template `Shell("synaptory skills get templates/context-packages/interface-contracts.tmpl")`
...
Write context package summary to `.synaptory/.orchestrator/context-packages/ui-contracts.md` — from template `Shell("synaptory skills get templates/context-packages/ui-contracts.tmpl")`
...
Write context package summary to `.synaptory/.orchestrator/context-packages/data-schema.md` — from template `Shell("synaptory skills get templates/context-packages/data-schema.tmpl")`
...
Write to `.synaptory/reverse-engineering/PRD.md` using template `Shell("synaptory skills get templates/prd.tmpl")`.
