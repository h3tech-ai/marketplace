...
5. **Write `.synaptory.yaml`** from template `${PLUGIN_ROOT}/roles/../_shared/templates/synaptory.yaml.tmpl`, filling in detected values. Continue with analysis.
...
- `dependency-map.md` — from template `${PLUGIN_ROOT}/roles/../_shared/templates/context-packages/dependency-map.tmpl.md`
- `interface-contracts.md` — from template `${PLUGIN_ROOT}/roles/../_shared/templates/context-packages/interface-contracts.tmpl.md`
...
Write context package summary to `.synaptory/.orchestrator/context-packages/ui-contracts.md` — from template `${PLUGIN_ROOT}/roles/../_shared/templates/context-packages/ui-contracts.tmpl.md`
...
Write context package summary to `.synaptory/.orchestrator/context-packages/data-schema.md` — from template `${PLUGIN_ROOT}/roles/../_shared/templates/context-packages/data-schema.tmpl.md`
...
Write to `.synaptory/reverse-engineering/PRD.md` using template `${PLUGIN_ROOT}/roles/../_shared/templates/prd.tmpl.md`.
