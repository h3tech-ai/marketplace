...
> **Version:** 1.1.3 · **Author:** [H3Tech Inc.](https://github.com/h3tech-ai) · **Distribution:** Proprietary
...
- Edit shared lifecycle, state, receipt, verification, and tracker logic in `plugin/`; recompose both host projections and keep Claude behavior green.
