...
- Prior pipeline artifacts -- any existing `.synaptory/` outputs from other skills
...
Write all outputs to `.synaptory/compliance-engineer/threat-model/`:
