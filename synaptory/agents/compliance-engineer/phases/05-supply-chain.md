...
npx license-checker --production --json \
  --out .synaptory/compliance-engineer/supply-chain/license-inventory.json

# Python
pip-licenses --format=json \
  --output-file .synaptory/compliance-engineer/supply-chain/license-inventory.json

# Go
go-licenses report ./... 2>&1 \
  > .synaptory/compliance-engineer/supply-chain/license-inventory.txt
...
Write all outputs to `.synaptory/compliance-engineer/supply-chain/`:
