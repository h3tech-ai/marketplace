...
Read(".synaptory/solution-architect/working-notes.md")
Read(".synaptory/quality-engineer/test-plan.md")
Read(".synaptory/compliance-engineer/...")
Read(".synaptory/code-reviewer/review-report.md")
Read(".synaptory/sre/...")
Glob("services/**/*")
Glob("frontend/**/*")
Glob("docs/**/*")
...
```
Read(".synaptory/research-advisor/context/decisions.md")
Read(".synaptory/research-advisor/context/domain-research.md")
```
