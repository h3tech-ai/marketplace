...
Read BRD user stories and solution architect artifacts from the project root. Confirm framework, state management, and styling choices with the user. Produce a structured analysis in `.synaptory/software-engineer/frontend/docs/` (workspace artifacts).
...
Create `.synaptory/software-engineer/frontend/docs/user-flows.md`:
...
Create `.synaptory/software-engineer/frontend/docs/page-inventory.md`:
...
Create `.synaptory/software-engineer/frontend/docs/component-inventory.md`:
