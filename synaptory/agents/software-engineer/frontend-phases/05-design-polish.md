...
**IF a design handoff bundle exists for the current story AND the handoff's `approved_at` is set**, Phase 5 does not run style selection or domain research — the client-approved prototype IS the style directive, and re-running WebSearch-driven trend research at this point can only *diverge* from what the client already approved.
...
Read engagement mode from `.synaptory/.orchestrator/settings.md`.
...
Document findings in `.synaptory/software-engineer-frontend/docs/design-research.md` including the selected style and how it maps to the domain.
...
- `.synaptory/software-engineer-frontend/docs/design-research.md` — Domain research, competitive analysis, trend findings
- `.synaptory/software-engineer-frontend/docs/design-decisions.md` — Color choices with rationale, typography selection, visual hierarchy rules
...
"Default blue with system fonts" is NOT synaptory.
...
THAT is synaptory — intentional design that matches the user's chosen style.
