...
4. **DoD evaluation** — `transition_story` auto-invokes `evaluate_ticket_dod` on the `→ done` transition; the result is stored on the ticket record. To re-run explicitly:
